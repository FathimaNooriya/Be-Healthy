...
class WeightModelAdapter extends TypeAdapter<WeightModel> {
  ...
  WeightModel read(BinaryReader reader) {
    ...
    return WeightModel(
      ...
      calorieIntakeNeeded: fields[4] as double,
      calorieBurnNeeded: fields[5] as double,
      weightTarget: fields[3] as double,
      weightTargetTime: fields[6] as String,
      reminingDaysNeeded: fields[7] as int,
    );
  }
  ...
  void write(BinaryWriter writer, WeightModel obj) {
    writer
      ...
      ..writeByte(4)
      ..write(obj.calorieIntakeNeeded)
      ..writeByte(5)
      ..write(obj.calorieBurnNeeded)
      ..writeByte(6)
